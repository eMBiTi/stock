...
class Discord(object):
    ...
    def __init__(self):
        ...
        print(Fore.GREEN)
        print("       __  __ ____  _ _______ _     ____                _           ")
        print("      |  \/  |  _ \(_)__   __(_)   |  _ \              | |          ")
        print("   ___| \  / | |_) |_   | |   _    | |_) | __ _ _ __ __| | ___ _ __ ")
        print("  / _ \ |\/| |  _ <| |  | |  | |   |  _ < / _` | '__/ _` |/ _ \ '__|")
        print(" |  __/ |  | | |_) | |  | |  | |   | |_) | (_| | | | (_| |  __/ |   ")
        print("  \___|_|  |_|____/|_|  |_|  |_|   |____/ \__,_|_|  \__,_|\___|_|   ")                                                                                                                              
        print("                                                                    ")
        print("                                                                    ")
        print("                                             -By eMBiTi#9994")
        print(" ")
        print(Style.RESET_ALL)

 
        self.nitro_type = input("\x1b[38;5;11mNitro Type\x1b[0m \x1b[38;5;12m(\x1b[0m\x1b[38;5;12mBasic\x1b[0m/\x1b[38;5;13mBoost\x1b[0m\x1b[38;5;12m)\x1b[0m ")
        self.nitro_duration = input("\x1b[38;5;11mNitro Duration\x1b[0m \x1b[38;5;12m(\x1b[0m\x1b[38;5;12mMonth\x1b[0m/\x1b[38;5;13mYear\x1b[0m\x1b[38;5;12m)\x1b[0m ")

        if self.nitro_type.lower() == "basic":
            if self.nitro_duration.lower() == "month":
                self.nitro_id = "533347165186887680"
